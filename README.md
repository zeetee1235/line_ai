...
실시간 감지와 스트리밍을 통해 빠르게 상황을 파악하고 대응할 수 있도록 설계되었습니다.
...
## 💡 추가 정보
- **비디오 스트리밍 URL**: 예시) `http://192.168.120.17:8080/video_feed`  
- **테스트 파일**: `/home/dev/line_ai/test.txt` 파일에 IP 및 스트림 정보를 확인할 수 있습니다.
